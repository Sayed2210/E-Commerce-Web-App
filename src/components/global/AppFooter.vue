<template>
  <v-footer :app="true" absolute class="bg-grey-lighten-2 py-5">
    <v-row no-gutters>
      <v-col cols="3">
        <v-card flat color="transparent">
          <v-card-title
            ...
            >Shop</v-card-title
          >
          <v-card-text class="pt-0 pl-0 text-subtitle-2"
          ...
          >
          <v-card-text class="pt-0 pl-0 text-subtitle-2">Cameras</v-card-text>
          <v-card-text class="pt-0 pl-0 text-subtitle-2"
      ...
      <v-col cols="3">
        <v-card flat color="transparent">
          ...
          >
          <v-card-text class="pt-0 pl-0 text-subtitle-2">About</v-card-text>
          <v-card-text class="pt-0 pl-0 text-subtitle-2"
      ...
      <v-col cols="3">
        <v-card flat color="transparent">
          ...
          <div
            class="adress text-subtitle-2 d-flex align-start justify-space-between pa-0"
            style="gap: 12px"
          >
            <span
              ><svg
              ...
              >
                ...
                ></path></svg
            ></span>
            <span class="px-4" style="line-height: 2"
              >685 Market Street San Franscico ,CA 3594974 , US 16541</span
            >
          </div>
          <div
            class="call text-subtitle-2 d-flex align-start pa-0 py-6"
            style="gap: 12px"
          >
            <span
              ><svg
            ...
            <span
              ...
              <span class="text-decoration-underline"
                >(415) 123 145 874</span
              ></span
            >
          </div>
          <div
            class="mail text-subtitle-2 d-flex align-start pa-0"
            style="gap: 12px"
          >
            <span
              ><svg
                ...
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
                class="svg-inline--fa fa-envelope fa-w-16 fa-7xpa-0"
              >
                <path
                  fill="currentColor"
                ...
                ></path></svg
            ></span>
            <span class="text-decoration-underline">eh600039@gmail.com</span>
          </div>
