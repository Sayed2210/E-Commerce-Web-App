    ...
    <v-container fluid>
      ...
      <v-row>
        ...
        <v-col cols="12" sm="6" class="d-flex justify-end" style="gap: 10px">
          ...
          <div class="lang d-flex align-center" id="lang-toggle">
            <span v-html="selected[0].icon"></span>
            <span>{{ selected[0].lang }}/{{ selected[0].currency }}</span>
            <v-menu activator="#lang-toggle">
              <v-list v-model:selected="selected">
                <v-list-item v-for="lang in langs" :key="lang.id">
