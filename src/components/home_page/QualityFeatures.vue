<template>
  <div class="quality-features py-12 bg-grey-lighten-4">
    <v-container fluid>
      <v-row>
        <v-col v-for="card in cards" :key="card.title">
          <v-hover v-slot="{ isHovering, props }">
            <v-card
              ...
              :color="isHovering ? 'grey-lighten-4' : 'white'"
            >
              <div class="parent">
                <span v-html="card.svg"></span>
                <v-card-text class="font-weight-bold text-uppercase pb-0">{{
                  card.title
                }}</v-card-text>
...
const cards = ref([
  ...
  },
  {
    ...
    description: "37 overseas warehoues",
  ...
  },
  {
    ...
    description: "More than 10 different secure payment method",
  ...
  },
  {
    ...
    description: "24/7 customer services- We're happy to help You",
